...
ggplot() +
  geom_line(data = steady.state, mapping = aes(x = time, y = mRNAr, colour = "Model")) +
  geom_line(data = steady.state, mapping = aes(x = time, y = DR_N, colour = "DR_NR"))

ggplot() +
  geom_line(data = normaal.verloop, mapping = aes(x = time, y = mRNAr, colour = "Model")) +
  geom_line(data = normaal.verloop, mapping = aes(x = time, y = DR_N, colour = "DR_NR"))
