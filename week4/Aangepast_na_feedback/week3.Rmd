...
layout(matrix(c(1 ,2, 3, 4, 5), ncol = 2, nrow = 3, byrow = TRUE))

layout(mat = matrix(c(1,1, 0, 2,2, 0,0, 3,3, 0,
                      4,4, 5,5), nrow = 2, byrow = TRUE))
layout.show(n = 5)
...
plot(verloop.dataset.lage.doses[,"R"],main = "Free (R) met lage dosis",type="l", xlab="Time", ylab="Free receptor", lwd = 2, xlim = c(0, 140), ylim = c(0, 500), col = "#21A9AD")
...
plot(verloop.dataset.hoge.doses[,"R"],main = "Free (R) met hoge dosis",type="l", xlab="Time", ylab="Free receptor", lwd = 2, xlim = c(0, 140), ylim = c(0, 500), col = "#21A9AD")
