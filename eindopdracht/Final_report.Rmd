...
Ten eerste wordt de verandering van borstweefsel berekend met gezonde stamcellen over de verandering in tijd. Het linker deel bepaald de afbraak van stamcellen. Het rechter gedeelte is de hoeveelheid stamcellen in verhouding met het aantal TSG's dat afhankelijk is van de mutatie waarschijnlijk in een normale situatie.
...
Jammer genoeg komen de resultaten uit deze uitwerking niet overeen met het artikel. Om deze reden worden daarom deze resultaten niet meegenomen in de resultaten sectie. Uiteraard volgt er in de discussiesectie nog een uitleg wat en waarom er precies niet goed ging aan deze benadering.
...
plot(out.0D, main = c("Fractie gezonde borst-stamcellen (f)", "Aanwezigheid LOH op TSG1 (q)",
                   ...
                   "Aantal tumorcellen (n)", "Aantal tumor geproduceerd MDE's (m)"),
...
Bij zowel de tumorcellen als MDE's is de toename van de eerste drie grafieken eerst zeer nihil, dit is terug te zien in figuur 1 aan de constante lijn in het begin.
