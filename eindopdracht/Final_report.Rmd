...
Er worden twee library's gebruikt. Ten eerste deSolve \cite{deSolve} (versie 1.35) voor de functie ODE en ODE.1D. Pracma wordt gebruikt om te kunnen partieel differentiëren bij de ODE.1D functie. Het modelleren wordt gedaan in R (versie 4.2.2).
