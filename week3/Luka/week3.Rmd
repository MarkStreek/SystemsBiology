...
plot(dataset.geen.R.synthese[, "mRNAr"], xlab = "Tijd (in uren)", ylab = "hoeveelheid R", type = "l",
main = "mRNAr productie (V)")
```
In figuur 6 is het verloop te zien van de hoeveelheid vrije R in grafiek U. Op de
y-as staat de hoeveelheid vrije R en op de x-as de tijd in uren. Om deze grafiek te maken 
...
aangemaakt. Dit is te zien in grafiek V waar de hoeveelheid mRNAr bij t ~ 20 constant blijft.
De hoeveelheid mRNAr wordt niet gebruikt, neemt niet toe en daalt ook niet.
