...
Hieronder zijn de parameters gebruikt bij opdracht 1. Wat belangrijk is om op te merken
is dat D niet in de vectoren wordt verwerkt, omdat de concentraties in het onderzoek varieëren
van 53.4 tot 39 tot 107. Als oplossing worden de concentraties direct aan functie ode() gegeven.

In deze opgave 1 worden twee simulaties gedraaid met D = 39 en D = 107.
...
```{r}
# Kon / 5
kon.parameters.g5 <- parameters["Kon"] = 0.00329 / 5
